...
var gauge = {
    ...
    modify: function(self, options) {
        ...
        if (self) {
            var i, q, g, c, n, a, z, l, t = 0,
                ...
                y = 0,
                x = 0,
                v = (self.width < self.height ? 1 : 0),
                r = parseInt(v ? self.width / 2 : self.height / 3),
                h = v ? self.height - r : r * 2,
                w = self.width,
                b = parseInt((v ? w : h) * 1.1),
            ...
            try {
                ...
                if (document.all && document.namespaces && !window.opera && self.tagName.toUpperCase() == "VAR" && (!document.documentMode || document.documentMode < 9)) {
                    var head, foot, fyll, flex, shadb, shadd, scalb = '',
                        scald = '',
                        j = 'm 0,0 l 0,' + parseInt((r - q) * 100) + ' qy ' + parseInt(q * 100) + ',' + parseInt(r * 100) + ' l ' + parseInt((w - q) * 100) + ',' + parseInt(r * 100) + ' qx ' + parseInt(w * 100) + ',' + parseInt((r - q) * 100) + ' l ' + parseInt(w * 100) + ',0 x e';
    ...
    remove: function(self) {
        if (self) {
            if (self.tagName.toUpperCase() == "CANVAS" || self.tagName.toUpperCase() == "VAR") {
