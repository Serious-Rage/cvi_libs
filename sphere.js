...
function addSphere() {
    ...
    if (cc.getContext || (document.all && document.namespaces && !window.opera && (!document.documentMode || document.documentMode < 9))) {
        if (typeof cvi_sphere != 'undefined') {
            var i, cl = '',
                sz, st, zo, op, sh, sd, c1, c2, img = getImages('sphere');
